...
--   Date and Time:   11:43 Wednesday August 19, 2026
--   Exported By:     MATHEUS
--   Flashback:       0
...
,p_created_on=>wwv_flow_imp.dz('20260724145104Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260819105012Z')
,p_created_by=>'MATHEUS.CATENACCI@ARTGROUP.COM.BR'
,p_last_updated_by=>'MATHEUS'
);
...
'  ',
unistr('  <!-- CABE\00C7ALHO COM CONTEXTO -->'),
'  <div style="background: linear-gradient(135deg, #E25F21 0%, #D45119 100%); border-radius: 12px; padding: 24px 28px; margin-bottom: 28px; display: flex; align-items: center; justify-content: space-between;">',
'    <div>',
...
'      </p>',
'    </div>',
unistr('    <div style="font-size: 48px; opacity: 0.2;">\D83C\DFED</div>'),
'  </div>',
'',
'  <!-- CARD PRINCIPAL: DASHBOARD (DESTACADO) -->',
'  <div style="margin-bottom: 28px;">',
'    <p style="margin: 0 0 14px 0; font-size: 11px; font-weight: 600; color: #7F7F7F; text-transform: uppercase; letter-spacing: 0.8px;">Acesso principal</p>',
'    ',
'    <div id="card-dashboard" style="background: #FFFBF9; border: 2px solid #E25F21; border-radius: 12px; padding: 32px 28px; box-shadow: 0 4px 16px rgba(226,95,33,0.12); cursor: pointer; transition: all 0.3s ease; min-height: 180px; display: flex; fl'
||'ex-direction: column; align-items: center; justify-content: center; text-align: center;"',
'      onmouseover="this.style.transform=''translateY(-8px)''; this.style.boxShadow=''0 12px 28px rgba(226,95,33,0.18)'';"',
'      onmouseout="this.style.transform=''translateY(0)''; this.style.boxShadow=''0 4px 16px rgba(226,95,33,0.12)'';"',
'      onclick="window.location.href=''f?p=101:2:&SESSION.:'';">',
'      ',
'      <div style="width: 56px; height: 56px; background: linear-gradient(135deg, #E25F21 0%, #D45119 100%); border-radius: 12px; display: flex; align-items: center; justify-content: center; margin-bottom: 16px;">',
'        <svg width="28" height="28" fill="none" stroke="#fff" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7"'
||' height="7"/></svg>',
'      </div>',
'      ',
unistr('      <h3 style="font-weight: 700; font-size: 18px; color: #000; margin: 0 0 8px 0;">Dashboard Log\00EDstica</h3>'),
'      <p style="font-size: 14px; color: #7F7F7F; margin: 0; line-height: 1.5;">Visualize ordens de carga, status em tempo real e alertas</p>',
'    </div>',
'  </div>',
'',
unistr('  <!-- CARDS SECUND\00C1RIOS (GRID 3 COLUNAS) -->'),
'  <div style="margin-bottom: 20px;">',
'    <p style="margin: 0 0 14px 0; font-size: 11px; font-weight: 600; color: #7F7F7F; text-transform: uppercase; letter-spacing: 0.8px;">Gerenciamento</p>',
'    ',
'    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 16px;">',
'',
'      <!-- CARD: ALERTAS (Verde) -->',
'      <div id="card-alertas" style="background: #fff; border: 0.5px solid #C0DD97; border-radius: 12px; padding: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); cursor: pointer; transition: all 0.3s ease;"',
'        onmouseover="this.style.transform=''translateY(-4px)''; this.style.boxShadow=''0 8px 16px rgba(59, 109, 17, 0.12)'';"',
'        onmouseout="this.style.transform=''translateY(0)''; this.style.boxShadow=''0 2px 8px rgba(0,0,0,0.06)'';"',
'        onclick="window.location.href=''f?p=101:3:&SESSION.:'';">',
'        ',
'        <div style="width: 48px; height: 48px; background: #EAF3DE; border-radius: 10px; display: flex; align-items: center; justify-content: center; margin-bottom: 14px;">',
'          <svg width="24" height="24" fill="none" stroke="#3B6D11" stroke-width="2" viewBox="0 0 24 24"><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9M13.73 21a2 2 0 01-3.46 0"/></svg>',
'        </div>',
'        ',
unistr('        <h4 style="font-weight: 700; font-size: 15px; color: #000; margin: 0 0 6px 0;">Configura\00E7\00E3o de Alertas</h4>'),
unistr('        <p style="font-size: 12px; color: #7F7F7F; margin: 0;">Gerencie notifica\00E7\00F5es do sistema</p>'),
'      </div>',
'',
'      <!-- CARD: CADASTRO (Azul) -->',
'      <div id="card-cadastro" style="background: #fff; border: 0.5px solid #B5D4F4; border-radius: 12px; padding: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); cursor: pointer; transition: all 0.3s ease;"',
'        onmouseover="this.style.transform=''translateY(-4px)''; this.style.boxShadow=''0 8px 16px rgba(24, 95, 165, 0.12)'';"',
'        onmouseout="this.style.transform=''translateY(0)''; this.style.boxShadow=''0 2px 8px rgba(0,0,0,0.06)'';"',
'        onclick="window.location.href=''f?p=101:5:&SESSION.:'';">',
'        ',
'        <div style="width: 48px; height: 48px; background: #E6F1FB; border-radius: 10px; display: flex; align-items: center; justify-content: center; margin-bottom: 14px;">',
'          <svg width="24" height="24" fill="none" stroke="#185FA5" stroke-width="2" viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"/></svg>',
'        </div>',
'        ',
unistr('        <h4 style="font-weight: 700; font-size: 15px; color: #000; margin: 0 0 6px 0;">Cadastro de Usu\00E1rios</h4>'),
unistr('        <p style="font-size: 12px; color: #7F7F7F; margin: 0;">Gerencie usu\00E1rios e permiss\00F5es</p>'),
'      </div>',
'',
'      <!-- CARD: ACESSOS (Vermelho) -->',
'      <div id="card-acessos" style="background: #fff; border: 0.5px solid #F7C1C1; border-radius: 12px; padding: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); cursor: pointer; transition: all 0.3s ease;"',
'        onmouseover="this.style.transform=''translateY(-4px)''; this.style.boxShadow=''0 8px 16px rgba(163, 45, 45, 0.12)'';"',
'        onmouseout="this.style.transform=''translateY(0)''; this.style.boxShadow=''0 2px 8px rgba(0,0,0,0.06)'';"',
'        onclick="window.location.href=''f?p=101:7:&SESSION.:'';">',
'        ',
'        <div style="width: 48px; height: 48px; background: #FCEBEB; border-radius: 10px; display: flex; align-items: center; justify-content: center; margin-bottom: 14px;">',
'          <svg width="24" height="24" fill="none" stroke="#A32D2D" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg>',
'        </div>',
'        ',
'        <h4 style="font-weight: 700; font-size: 15px; color: #000; margin: 0 0 6px 0;">Gerenciador de Acessos</h4>',
unistr('        <p style="font-size: 12px; color: #7F7F7F; margin: 0;">Controle de acessos por usu\00E1rio</p>'),
'      </div>',
'',
'    </div>',
'  </div>',
...
,p_updated_on=>wwv_flow_imp.dz('20260819105012Z')
,p_created_by=>'MATHEUS'
,p_updated_by=>'MATHEUS'
);
...
,p_inline_css=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* ============================================================',
unistr('   PAGE 2 \2014 DASHBOARD LOG\00CDSTICA \2014 CSS COMPLETO'),
'   ArtOne | ArtPetro | #E25F21',
'   Atualizado: 19/08/2026',
'   ============================================================ */',
'',
'/* ------------------------------------------------------------',
unistr('   CABE\00C7ALHO DAS TABELAS \2014 gradiente laranja ArtPetro'),
'   ------------------------------------------------------------ */',
...
'}',
'',
unistr('/* Links dos cabe\00E7alhos */'),
...
'',
'/* ------------------------------------------------------------',
unistr('   T\00CDTULO DAS REGI\00D5ES'),
'   ------------------------------------------------------------ */',
'.t-Region-title {',
...
'',
'/* ------------------------------------------------------------',
unistr('   KPIs \2014 N\00DAMEROS GIGANTES (TV-FRIENDLY)'),
'   ------------------------------------------------------------ */',
...
'}',
'',
unistr('/* T\00EDtulo do KPI maior pra TV */'),
...
'',
'/* ------------------------------------------------------------',
unistr('   BOT\00C3O DISPARAR ALERTAS'),
'   ------------------------------------------------------------ */',
'.btn-disparar-alertas {',
...
'  border: none !important;',
'}',
'.btn-disparar-alertas:hover {',
'  background-color: #C04A1A !important;',
'}',
'.btn-disparar-alertas:disabled {',
'  opacity: 0.5 !important;',
'  cursor: not-allowed !important;',
'}',
'',
'/* ------------------------------------------------------------',
'   LOG POPUP (modal de alertas)',
'   ------------------------------------------------------------ */',
'.log-overlay {',
'  position: fixed;',
'  top: 0; left: 0;',
...
'}',
'',
'/* Label Mostrar Kanban maior */',
'.label-kanban .t-Form-label {',
'  font-size: 16px !important;',
'  font-weight: 700 !important;',
'  color: #2c2c2a !important;',
'}'))
...
'',
unistr('    -- SISPETRO \2014 cinza neutro'),
'    HTP.P(''<span style="display:inline-flex; align-items:center; gap:7px; background:#F1EFE8; color:#5F5E5A; padding:7px 14px; border-radius:22px; border:1px solid #C9C9C9; font-size:14px; font-weight:600;">'');',
'    HTP.P(''<span style="width:9px; height:9px; border-radius:50%; background:#7F7F7F;"></span>'');',
'    HTP.P(''Sispetro &middot; sync '' || v_ultima_sync);',
'    HTP.P(''</span>'');',
'',
unistr('    -- ENGERISCO \2014 cinza neutro'),
'    HTP.P(''<span style="display:inline-flex; align-items:center; gap:7px; background:#F1EFE8; color:#5F5E5A; padding:7px 14px; border-radius:22px; border:1px solid #C9C9C9; font-size:14px; font-weight:600;">'');',
'    HTP.P(''<span style="width:9px; height:9px; border-radius:50%; background:#7F7F7F;"></span>'');',
...
,p_updated_on=>wwv_flow_imp.dz('20260819112611Z')
,p_created_by=>'MATHEUS.CATENACCI@ARTGROUP.COM.BR'
,p_updated_by=>'MATHEUS'
);
wwv_flow_imp_page.create_page_plug(
...
'  v_html CLOB := '''';',
'BEGIN',
'  v_html := v_html || ''<div style="display:flex; gap:12px; align-items:flex-start;">'';',
...
'',
unistr('    -- CABE\00C7ALHO DA COLUNA (era 12px \2192 14px; contador era 10px \2192 13px)'),
'    v_html := v_html || ''<div style="padding:10px 14px; background:''||col.bg_head||''; color:''||col.cor_head||''; font-size:14px; font-weight:700; display:flex; justify-content:space-between; align-items:center;">'';',
'    v_html := v_html || ''<span>''||col.status||''</span>'';',
'    v_html := v_html || ''<span style="background:''||col.cor_borda||''; color:#fff; border-radius:20px; padding:2px 10px; font-size:13px; font-weight:700;">''||v_qtd||''</span>'';',
'    v_html := v_html || ''</div>'';',
'',
'    v_html := v_html || ''<div style="padding:8px; display:flex; flex-direction:column; gap:8px;">'';',
'',
'    FOR j IN (',
'      SELECT num_ped,',
...
'    ) LOOP',
'      v_html := v_html || ''<div style="background:#fff; border:0.5px solid #e5e5e0; border-left:3px solid ''||col.cor_borda||''; border-radius:5px; padding:10px 12px;">'';',
'',
unistr('      -- N\00FAmero do pedido (era 12px \2192 14px)'),
'      v_html := v_html || ''<div style="font-size:14px; font-weight:700; color:#2c2c2a; margin-bottom:4px;">Pedido ''||j.num_ped||''</div>'';',
'',
unistr('      -- Cliente (era 11px \2192 13px)'),
'      v_html := v_html || ''<div style="font-size:13px; font-weight:600; color:#3d3d3b; margin-bottom:3px;">''||j.cliente||''</div>'';',
'',
unistr('      -- Produto (era 10px \2192 13px)'),
'      v_html := v_html || ''<div style="font-size:13px; font-weight:500; color:''||col.cor_borda||''; margin-bottom:4px;">''||j.produto||''</div>'';',
'',
unistr('      -- Placa e motorista (era 10px \2192 12px)'),
unistr('      v_html := v_html || ''<div style="font-size:12px; color:#888780; margin-bottom:2px;">''||j.placa||'' \00B7 ''||j.motorista||''</div>'';'),
'',
unistr('      -- Frete (era 10px \2192 12px)'),
'      v_html := v_html || ''<div style="font-size:12px; font-weight:600; color:#61615E;">''||j.frete||''</div>'';',
'',
'      v_html := v_html || ''</div>'';',
'    END LOOP;',
'',
'    IF v_qtd = 0 THEN',
'      v_html := v_html || ''<div style="font-size:13px; color:#b4b2a9; text-align:center; padding:16px 0;">Nenhum pedido</div>'';',
'    END IF;',
'',
...
,p_updated_on=>wwv_flow_imp.dz('20260819112518Z')
,p_created_by=>'MATHEUS.CATENACCI@ARTGROUP.COM.BR'
,p_updated_by=>'MATHEUS'
);
wwv_flow_imp_page.create_page_plug(
...
,p_title=>'Jornada da Carga'
,p_region_css_classes=>'kpi-artpetro'
...
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT ',
unistr('  ''\26A0\FE0F ATRASADAS'' titulo,'),
'  (SELECT COUNT(*) FROM vw_jornada_carga WHERE status_oc = ''Atrasado'') valor,',
'  ''danger'' cor,',
'  ''alert'' icone,',
'  ''kpi-artpetro kpi-danger'' css_class',
'FROM DUAL',
'UNION ALL SELECT ',
unistr('  ''\D83D\DE9A EM TR\00C2NSITO'','),
unistr('  (SELECT COUNT(*) FROM vw_jornada_carga WHERE status_oc = ''Em Tr\00E2nsito''),'),
'  ''info'', ''arrow-right'',',
'  ''kpi-artpetro kpi-info''',
'FROM DUAL',
'UNION ALL SELECT ',
unistr('  ''\23F3 AGUARDANDO'','),
unistr('  (SELECT COUNT(*) FROM vw_jornada_carga WHERE status_oc IN (''Aguardando Carregamento'', ''Sem Ve\00EDculo Alocado'')),'),
'  ''warning'', ''clock'',',
'  ''kpi-artpetro kpi-warning''',
'FROM DUAL',
'UNION ALL SELECT ',
unistr('  ''\2705 ENTREGUES'','),
'  (SELECT COUNT(*) FROM vw_jornada_carga WHERE status_oc = ''Entregue''),',
'  ''success'', ''check'',',
'  ''kpi-artpetro kpi-success''',
'FROM DUAL',
'UNION ALL SELECT ',
unistr('  ''\2715 CANCELADOS'','),
'  (SELECT COUNT(*) FROM vw_jornada_carga WHERE status_oc = ''Cancelada''),',
'  ''danger'', ''times'',',
'  ''kpi-artpetro kpi-danger''',
'FROM DUAL'))
,p_lazy_loading=>false
...
,p_updated_on=>wwv_flow_imp.dz('20260819110926Z')
,p_created_by=>'MATHEUS.CATENACCI@ARTGROUP.COM.BR'
,p_updated_by=>'MATHEUS'
);
...
,p_updated_on=>wwv_flow_imp.dz('20260819110814Z')
,p_updated_by=>'MATHEUS'
);
wwv_flow_imp_page.create_page_plug(
...
,p_warn_on_unsaved_changes=>null
,p_button_css_classes=>'btn-disparar-alertas'
...
,p_updated_on=>wwv_flow_imp.dz('20260819110133Z')
,p_created_by=>'MATHEUS.CATENACCI@ARTGROUP.COM.BR'
,p_updated_by=>'MATHEUS'
);
wwv_flow_imp_page.create_page_item(
...
,p_item_plug_id=>wwv_flow_imp.id(21431423801934946964)
,p_item_default=>'N'
,p_prompt=>'Mostrar Kanban '
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_YES_NO'
,p_field_template=>1610598304472262251
,p_item_css_classes=>'label-kanban'
...
,p_updated_on=>wwv_flow_imp.dz('20260819112842Z')
,p_created_by=>'MATHEUS.CATENACCI@ARTGROUP.COM.BR'
,p_updated_by=>'MATHEUS'
);
wwv_flow_imp_page.create_page_da_event(
...
'  IF v_count = 0 THEN',
'    -- ESTADO VAZIO',
'    v_html := v_html || ''<div style="text-align:center; padding:32px; color:#888; font-size:14px;">Nenhum alerta registrado para este pedido.</div>'';',
'  ELSE',
'    FOR r IN (',
'      SELECT',
'        a.ID_ALERTA,',
...
'    ) LOOP',
'',
'      -- COR DA BORDA LATERAL: vermelho se ATIVO, cinza se RESOLVIDO',
'      DECLARE',
'        v_cor_borda VARCHAR2(20);',
'        v_bg        VARCHAR2(20);',
'        v_cor_borda_card VARCHAR2(20);',
'      BEGIN',
'        IF r.STATUS = ''ATIVO'' THEN',
'          v_cor_borda      := ''#A32D2D'';',
'          v_bg             := ''#FFFAFA'';',
'          v_cor_borda_card := ''#F5C6C6'';',
'        ELSE',
'          v_cor_borda      := ''#C9C9C9'';',
'          v_bg             := ''#FAFAFA'';',
'          v_cor_borda_card := ''#E8E8E8'';',
'        END IF;',
'',
'        v_html := v_html || ''<div style="border:1px solid '' || v_cor_borda_card || ''; border-left:4px solid '' || v_cor_borda || ''; border-radius:6px; padding:14px 16px; margin-bottom:10px; background:'' || v_bg || '';">'';',
'',
'        -- HEADER: tipo + badge status',
'        v_html := v_html || ''<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px;">'';',
'        v_html := v_html || ''<div style="font-size:14px; font-weight:700; color:#2c2c2a;">'' || NVL(r.TIPO_ALERTA, ''ALERTA'') || ''</div>'';',
'',
'        IF r.STATUS = ''ATIVO'' THEN',
unistr('          v_html := v_html || ''<span style="background:#FADBD8; color:#A32D2D; padding:4px 12px; border-radius:20px; font-size:12px; font-weight:700; border:1px solid #A32D2D;">\25CF ATIVO</span>'';'),
'        ELSE',
unistr('          v_html := v_html || ''<span style="background:#F0F0F0; color:#7F7F7F; padding:4px 12px; border-radius:20px; font-size:12px; font-weight:700; border:1px solid #C9C9C9;">\25CB '' || NVL(r.STATUS, ''INATIVO'') || ''</span>'';'),
'        END IF;',
'',
'        v_html := v_html || ''</div>'';',
'',
unistr('        -- DESCRI\00C7\00C3O'),
unistr('        v_html := v_html || ''<div style="font-size:13px; color:#444; margin-bottom:10px; line-height:1.5;">'' || NVL(r.DESCRICAO, ''Sem descri\00E7\00E3o'') || ''</div>'';'),
'',
unistr('        -- DATA E USU\00C1RIO'),
'        v_html := v_html || ''<div style="display:flex; gap:20px; margin-bottom:12px;">'';',
unistr('        v_html := v_html || ''<div style="font-size:13px; color:#7F7F7F;">\D83D\DCC5 '' || r.DT || ''</div>'';'),
unistr('        v_html := v_html || ''<div style="font-size:13px; color:#7F7F7F;">\D83D\DC64 '' || NVL(r.USUARIO, ''Sistema'') || ''</div>'';'),
'        v_html := v_html || ''</div>'';',
'',
unistr('        -- BOT\00D5ES (s\00F3 para ATIVO)'),
'        IF r.STATUS = ''ATIVO'' THEN',
'          v_html := v_html || ''<div style="display:flex; gap:8px; flex-wrap:wrap;">'';',
'',
'          IF r.ENVIAR_WHATSAPP = 1 THEN',
'            v_html := v_html || ''<button onclick="reenviarWhatsApp('' || r.ID_CONFIG || '','''''' || v_num_ped || '''''')" ''',
'                             || ''style="background:#25D366; color:#fff; border:none; border-radius:6px; padding:8px 16px; font-size:13px; font-weight:600; cursor:pointer;">''',
unistr('                             || ''\D83D\DCF1 WhatsApp</button>'';'),
'          END IF;',
'',
'          IF r.ENVIAR_EMAIL = 1 THEN',
'            v_html := v_html || ''<button onclick="reenviarEmail('' || r.ID_CONFIG || '','''''' || v_num_ped || '''''')" ''',
'                             || ''style="background:#E25F21; color:#fff; border:none; border-radius:6px; padding:8px 16px; font-size:13px; font-weight:600; cursor:pointer;">''',
unistr('                             || ''\2709\FE0F Email</button>'';'),
'          END IF;',
'',
'          v_html := v_html || ''<button onclick="resolverAlerta('' || r.ID_ALERTA || '','''''' || v_num_ped || '''''')" ''',
'                           || ''style="background:#27AE60; color:#fff; border:none; border-radius:6px; padding:8px 16px; font-size:13px; font-weight:600; cursor:pointer;">''',
...
,p_updated_on=>wwv_flow_imp.dz('20260819113843Z')
,p_created_by=>'MATHEUS'
,p_updated_by=>'MATHEUS'
);
wwv_flow_imp_page.create_page_process(
...
'',
'  -- ============================================================',
'  -- CARDS SISPETRO + ENGERISCO',
'  -- ============================================================',
'  v_html := ''<div style="display:flex; gap:12px; margin-bottom:16px;">'';',
'',
'  -- SISPETRO',
'  v_html := v_html || ''<div style="flex:1; background:#FFF8F0; border:1px solid #FFD9B3; border-radius:8px; padding:14px;">'';',
'  v_html := v_html || ''<div style="display:inline-block; background:#E25F21; color:#fff; font-size:11px; font-weight:700; padding:3px 10px; border-radius:20px; margin-bottom:12px; letter-spacing:0.5px;">SISPETRO</div>'';',
'  v_html := v_html || ''<div style="font-size:14px; color:#444; margin-bottom:6px;"><b>Pedido:</b> '' || v_num_ped || ''</div>'';',
unistr('  v_html := v_html || ''<div style="font-size:14px; color:#444; margin-bottom:6px;"><b>Tipo:</b> '' || CASE v_tipo WHEN ''C'' THEN ''Compra'' WHEN ''T'' THEN ''Transfer\00EAncia'' WHEN ''VD'' THEN ''Venda'' ELSE NVL(v_tipo, ''N\00E3o informado'') END || ''</div>'';'),
unistr('  v_html := v_html || ''<div style="font-size:14px; color:#444; margin-bottom:6px;"><b>Status:</b> '' || NVL(INITCAP(v_status), ''N\00E3o informado'') || ''</div>'';'),
unistr('  v_html := v_html || ''<div style="font-size:14px; color:#444; margin-bottom:6px;"><b>Cliente:</b> '' || NVL(v_cliente, ''N\00E3o informado'') || ''</div>'';'),
unistr('  v_html := v_html || ''<div style="font-size:14px; color:#444; margin-bottom:6px;"><b>Produto:</b> '' || NVL(v_produto, ''N\00E3o informado'') || ''</div>'';'),
unistr('  v_html := v_html || ''<div style="font-size:14px; color:#444;"><b>Criado por:</b> '' || NVL(v_usuario, ''N\00E3o informado'') || ''</div>'';'),
'  v_html := v_html || ''</div>'';',
'',
'  -- ENGERISCO',
'  v_html := v_html || ''<div style="flex:1; background:#F0F4FF; border:1px solid #B3C9FF; border-radius:8px; padding:14px;">'';',
'  v_html := v_html || ''<div style="display:inline-block; background:#3498DB; color:#fff; font-size:11px; font-weight:700; padding:3px 10px; border-radius:20px; margin-bottom:12px; letter-spacing:0.5px;">ENGERISCO</div>'';',
'  IF v_oc IS NOT NULL THEN',
'    v_html := v_html || ''<div style="font-size:14px; color:#444; margin-bottom:6px;"><b>OC:</b> '' || v_oc || ''</div>'';',
unistr('    v_html := v_html || ''<div style="font-size:14px; color:#444; margin-bottom:6px;"><b>Status:</b> '' || NVL(v_status_car, ''N\00E3o informado'') || ''</div>'';'),
unistr('    v_html := v_html || ''<div style="font-size:14px; color:#444; margin-bottom:6px;"><b>Motorista:</b> '' || NVL(v_motorista, ''N\00E3o informado'') || ''</div>'';'),
unistr('    v_html := v_html || ''<div style="font-size:14px; color:#444;"><b>Placa:</b> '' || NVL(v_placa, ''N\00E3o informado'') || ''</div>'';'),
'  ELSE',
'    v_html := v_html || ''<div style="font-size:14px; color:#888; font-style:italic;">Sem OC gerada para este pedido</div>'';',
'  END IF;',
'  v_html := v_html || ''</div>'';',
'',
'  v_html := v_html || ''</div>'';',
'',
'  -- ============================================================',
unistr('  -- HIST\00D3RICO'),
'  -- ============================================================',
'  SELECT COUNT(*) INTO v_tem_log FROM DAB_LOG_PEDIDO WHERE NUM_PED = v_num_ped;',
'',
unistr('  v_html := v_html || ''<div style="font-size:14px; font-weight:700; color:#2c2c2a; margin-bottom:10px; padding-bottom:6px; border-bottom:2px solid #E25F21;">Hist\00F3rico</div>'';'),
'',
'  IF v_tem_log = 0 THEN',
unistr('    v_html := v_html || ''<div style="font-size:13px; color:#b4b2a9; text-align:center; padding:20px 0;">Nenhum registro no hist\00F3rico</div>'';'),
'  ELSE',
...
'    ) LOOP',
'      v_html := v_html || ''<div style="display:flex; align-items:flex-start; gap:12px; padding:10px 14px; border-bottom:1px solid #f3f3f3;">'';',
'      v_html := v_html || ''<div style="min-width:120px; font-size:13px; color:#888; white-space:nowrap;">'' || r.DT || ''</div>'';',
'      v_html := v_html || ''<div style="min-width:110px; font-size:13px; font-weight:600; color:#333;">'' || r.USUARIO || ''</div>'';',
'      v_html := v_html || ''<div style="font-size:13px; color:#555;">'' || r.ACAO || ''</div>'';',
'      v_html := v_html || ''</div>'';',
'    END LOOP;',
'    v_html := v_html || ''</div>'';',
'  END IF;',
...
,p_updated_on=>wwv_flow_imp.dz('20260819113518Z')
,p_created_by=>'MATHEUS.CATENACCI@ARTGROUP.COM.BR'
,p_updated_by=>'MATHEUS'
);
wwv_flow_imp_page.create_page_process(
